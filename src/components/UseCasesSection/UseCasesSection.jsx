...
import PrevImg from "../../img/o_prev.png";
    ...
    <S.UseCasesSection ref={scrollToRef} id="cases">
      ...
      <S.Top ref={topRef}>
        ...
        <S.LogoHeadline>
          ...
          <S.Headline>AI Agents Examples</S.Headline>
        </S.LogoHeadline>
        <S.Text>
          We start with specific use cases and build custom AI Agents to solve
          each of them impeccably.
        </S.Text>
      </S.Top>
      <Cases />
