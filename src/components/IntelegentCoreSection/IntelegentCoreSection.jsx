            ...
            <S.Content ref={contentRef}>
                ...
                <S.RightContent>
                    ...
                    <S.AdvantagesList>
                        ...
                        <li>Enterprise-grade data security and complete data sovereignty. Upstrima doesn’t learn from client’s data.</li>
                        <li>Full regulatory compliance with complete audit capabilities</li>
                        <li>Simple, transparent, affordable and predictable pricing with flexible monthly subscriptions</li>
                        <li>White-glove service with dedicated customization,  implementation, training and support teams</li>
                        <li>Personal account manager for corporate clients</li>
                    </S.AdvantagesList>
                    <S.BigText>
